...
public class GUIstart {
	...
	//Global signInPanel
	private boolean keyEventFirst = false;
	private JTextField txtField_SignInPanel_Email = new JTextField();
	private JPasswordField passwordField_SignInPanel_Password = new JPasswordField();
	...
	private void signInPanel(){		
		...
		//EmailField
		txtField_SignInPanel_Email.addKeyListener(new KeyAdapter() {
			@Override
			public void keyPressed(KeyEvent arg0) {
				if(keyEventFirst == false){
		...
		//PasswordField
		passwordField_SignInPanel_Password.addFocusListener(new FocusAdapter() {
			@Override
